...
const WELCOME_BACKGROUND_URL = "https://res.cloudinary.com/ddznxtb6f/image/upload/v1770656057/unnamed_7_ejulhy.jpg";
    ...
    <div className="relative h-screen w-full overflow-hidden bg-background">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="حيّان Welcome Background"
          fill
          className="object-cover"
          priority
          data-ai-hint="leaves tree background"
        />
      </div>
        ...
        <div className="w-full max-w-xs mx-auto space-y-6">
          ...
          <div className="text-center">
            <p className="text-black font-black text-sm">
              لديك حساب بالفعل؟ <button onClick={() => router.push("/auth")} className="text-primary underline underline-offset-4">تسجيل الدخول</button>
            </p>
          </div>
        </div>
      </div>

...
const NEIGHBORHOODS = [
  ...
  "العليا", "الروابي", "الراكة الشمالية", "الراكة الجنوبية", 
  "الخزامى", "الجسر", "الجامعيين", "التعاون", "الأندلس", "الكورنيش", "الخبر الشرقية", 
...
const TreeSVG = () => (
  <svg className="tree" viewBox="0 0 155.31 222.72" xmlns="http://www.w3.org/2000/svg">
    <path fill="#4e7246" d="M155.31 222.72H0l18.42-32.01h20.47L0 156.09h32.25L0 101.43h48.24L0 46.77 77.66 0l77.65 46.77-48.24 54.66h48.24L77.66 156.09h32.25l-38.65 34.62h20.47z" />
  </svg>
);

const WaveSVG = () => (
  <svg className="wave" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
    <path fill="#76a36c" fillOpacity="1" d="M0,192L48,176C96,160,192,128,288,128C384,128,480,160,576,186.7C672,213,768,235,864,224C960,213,1056,171,1152,144C1248,117,1344,107,1392,101.3L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
  </svg>
);
